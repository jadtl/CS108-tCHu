...
public class ObservableGameState {
  ...
  public void setState(PublicGameState newState, PlayerState ownState) {
    this.remainingTicketsPercentage = new SimpleIntegerProperty(newState.ticketsCount() / ChMap.tickets().size());
    this.remainingCardsPercentage = new SimpleIntegerProperty(newState.cardState().deckSize() / Constants.TOTAL_CARDS_COUNT);
